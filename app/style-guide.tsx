...
import { Typography, Button, InputBox, TextBox, WiggleBorder, SearchBox } from "@/components";
      ...
      <View className=" flex h-full gap-6">
        ...
        <View className="flex gap-4">
          ...
          <View className="flex gap-5">
            ...
            <View className="grow flex gap-4">
              <SearchBox color="primary" placeholder="primary" onSubmit={() => {}} />
              <SearchBox color="secondary" placeholder="secondary" onSubmit={() => {}} />
              <SearchBox
                color="secondary-dark"
                placeholder="secondary-dark (default) "
                onSubmit={() => {}}
              />
            </View>
          </View>
